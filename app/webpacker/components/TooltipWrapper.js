...
const TooltipWrapper = ({text, className, width, position, children}) => {
	...
	return (
		...
		>
			{children}
			<div className={classNames("absolute bg-black text-white text-xs rounded p-3 right-0 bottom-full text-center z-10", {"hidden": !inHover}, {[widthString]: !!widthVar})}

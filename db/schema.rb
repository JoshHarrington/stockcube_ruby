...
ActiveRecord::Schema.define(version: 20180310154232) do
  ...
  create_table "recipes", force: :cascade do |t|
    ...
    t.index ["shopping_list_id"], name: "index_recipes_on_shopping_list_id"
  end
  ...
  add_foreign_key "recipes", "shopping_lists"
